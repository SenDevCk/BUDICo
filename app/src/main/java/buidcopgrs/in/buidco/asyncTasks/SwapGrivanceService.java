...
public class SwapGrivanceService extends AsyncTask<String,Void, String> {
    Activity activity;
    private ProgressDialog dialog1;
    private AlertDialog alertDialog;
    public SwapGrivanceService(Activity activity){
    ...
    protected void onPreExecute() {
        super.onPreExecute();
        dialog1.setMessage("Swaping Grivance Type...");
    ...
    protected String doInBackground(String... strings) {
        ...
        if (Utiilties.isOnline(activity)) {
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
                result = WebServiceHelper.SwapGrivance(strings);
            }else{
